...
//add by dupeng for lcd sleep 2013/04/19
#define CLKLN_ULPS_REQUEST		1<<4
#define CLKLN_ULPS_REQUEST_DISABLE	0xffffffef
#define DLN1_ULPS_REQUEST		1<<1
#define DLN1_ULPS_REQUEST_DISABLE 0xFFFFFFFD
#define CLKLN_ULPS_EXIT			1<<12
#define CLKLN_ULPS_EXIT_DISABLE 0xFFFFEFFF
#define DLN1_ULPS_EXIT			1<<9
#define DLN1_ULPS_EXIT_DISABLE 	0xFFFFFDFF
#define DSI1_CLKLN_EN			1<<8
#define DSI1_CLKLN_DISABLE		0xFFFFFEFF
#define DSI1_DLN1_EN			1<<5
#define DSI1_DLN1_DISABLE		0xFFFFFFDF
...
void mipi_dsi1_ulps_mode(int on);//add by dupeng for lcd sleep
