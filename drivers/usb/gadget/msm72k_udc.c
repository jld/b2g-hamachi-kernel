...
//pcyang added the NON_GB charger current
#define NON_GB_WALLCHARGER_CURRENT	500
static int usb_get_max_power(struct usb_info *ui)
{
	...
	/*pcyang added for support the NON_GB charger--fix pr431351  2013-04-19*/
	if (temp == USB_CHG_TYPE__SDP)
		return NON_GB_WALLCHARGER_CURRENT;
	/*pcyang added end*/
