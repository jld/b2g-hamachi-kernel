...
int gpio_bt_sys_rest_en = 114;
static void gpio_bt_config(void)
{
	u32 socinfo = socinfo_get_platform_version();
    /*add 7x27a_ffa for Beetle-lite-ff by zhaiqingbo 2013.1.31 */
	if (machine_is_msm7627a_qrd1()||machine_is_msm7625a_ffa()||machine_is_msm7x27a_ffa())
