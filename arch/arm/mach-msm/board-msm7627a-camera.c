...
#include <mach/vreg.h>
//fan xin 2012-10-15 for camera driver begin
//#define GPIO_CAM_3MP_HVGA_SHDN          120
#define GPIO_CAM_3MP_HVGA_SHDN          113
//#define GPIO_CAM_3MP_HVGA_RESET_N       121
#define GPIO_CAM_3MP_HVGA_RESET_N       84
//fan xin 2012-10-15 for camera driver end
...
#ifdef CONFIG_S5K5CA
static struct camera_vreg_t msm_cam_vreg_s5k5ca[] = {
...
static struct camera_vreg_t msm_cam_vreg[] = {
	{"rfrx1", REG_LDO, 2800000, 2800000, 0x10},
};
...
static struct msm_camera_sensor_platform_info sensor_board_info_s5k5ca = {
	.mount_angle = 90,
	.cam_vreg = msm_cam_vreg_s5k5ca,
	.num_vreg = ARRAY_SIZE(msm_cam_vreg_s5k5ca),
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k5ca_data = {
	...
	.sensor_reset_enable = 1,
	.pmic_gpio_enable  = 1,
	.sensor_reset   = GPIO_CAM_3MP_HVGA_RESET_N,
	.sensor_pwd     = GPIO_CAM_3MP_HVGA_SHDN,
	.pdata          = &msm_camera_device_data_csi1[0],
...
#endif
#ifdef CONFIG_HYNIX256
static struct msm_camera_gpio_conf gpio_conf_hynix256 = {
	.camera_off_table = camera_off_gpio_table,
	.camera_on_table = camera_on_gpio_table,
	.gpio_no_mux = 1,
};
static struct msm_camera_sensor_platform_info sensor_board_info_hynix256 = {
	.mount_angle = 90,
	.cam_vreg = msm_cam_vreg,
	.num_vreg = ARRAY_SIZE(msm_cam_vreg),
	.gpio_conf = &gpio_conf_hynix256,
};

static struct msm_camera_sensor_flash_src msm_flash_src_hynix256 = {
	.flash_sr_type = MSM_CAMERA_FLASH_SRC_LED,
	._fsrc.led_src.led_name = "flashlight",
	._fsrc.led_src.led_name_len = 10,
};

static struct msm_camera_sensor_flash_data flash_hynix256 = {
	.flash_type     = MSM_CAMERA_FLASH_NONE,//MSM_CAMERA_FLASH_LED,
	.flash_src      = &msm_flash_src_hynix256,
};
 
static struct msm_camera_sensor_info msm_camera_sensor_hynix256_data = {
	.sensor_name    = "hynix256",
	.sensor_reset_enable = 1,
	.pmic_gpio_enable  = 1,
	.sensor_reset   = GPIO_CAM_3MP_HVGA_RESET_N,
	.sensor_pwd     = GPIO_CAM_3MP_HVGA_SHDN,
	.pdata          = &msm_camera_device_data_csi1[0],
	.flash_data     = &flash_hynix256,
	.sensor_platform_info   = &sensor_board_info_hynix256,
	.csi_if                 = 1,
	.camera_type	= BACK_CAMERA_2D,
	.sensor_type = YUV_SENSOR,
};
...
#ifdef CONFIG_HYNIX256
       {
		I2C_BOARD_INFO("hynix256", 0x40),
		.platform_data = &msm_camera_sensor_hynix256_data,
	},
#endif
};
#else
...
{
#if defined (CONFIG_SENSOR_OV5647) && defined (CONFIG_MSM_CAMERA_V4L2)
	int rc = 0;
